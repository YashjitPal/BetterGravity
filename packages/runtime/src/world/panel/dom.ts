...
/** Small element builder, so the panel reads as structure rather than plumbing. */
...
export function toggleSwitch(checked: boolean, label: string, onChange: () => void): HTMLButtonElement {
